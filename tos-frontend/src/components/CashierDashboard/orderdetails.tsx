...
const OrderDetails: React.FC = () => {
  ...
  const [popupState, setPopupState] = useState({ isOpen: false, title: '', message: '', variant: 'default' as const });
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      setPopupState({
        isOpen: true,
        title: "Error",
        message: error instanceof Error ? error.message : "There was an error placing the order. Please try again.",
        variant: 'error'
      });
    }
  };
